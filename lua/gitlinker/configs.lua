...
local Defaults = {
  ...
  router = {
    browse = {
      -- example: https://github.com/fcbry/gitlinker.nvim/blob/9679445c7a24783d27063cd65f525f02def5f128/lua/gitlinker.lua#L3-L4
      ...
      -- example: https://gitlab.com/fcbry/test/blob/e1c498a4bae9af6e61a2f37e7ae622b2cc629319/test.lua#L3-L5
      ...
      -- example: https://codeberg.org/fcbry/gitlinker.nvim/src/commit/a570f22ff833447ee0c58268b3bae4f7197a8ad8/LICENSE#L4-L7
    ...
    blame = {
      -- example: https://github.com/fcbry/gitlinker.nvim/blame/9679445c7a24783d27063cd65f525f02def5f128/lua/gitlinker.lua#L3-L7
      ["^github%.com"] = "https://github.com/"
          .. "{_A.ORG}/"
          .. "{_A.REPO}/blame/"
          .. "{_A.REV}/"
          ...
          .. "#L{_A.LSTART}"
          .. "{(_A.LEND > _A.LSTART and ('-L' .. _A.LEND) or '')}",
      -- example: https://gitlab.com/fcbry/test/blame/e1c498a4bae9af6e61a2f37e7ae622b2cc629319/test.lua#L4-8
      ["^gitlab%.com"] = "https://gitlab.com/"
          .. "{_A.ORG}/"
          .. "{_A.REPO}/blame/"
          .. "{_A.REV}/"
      ...
      ["^bitbucket%.org"] = "https://bitbucket.org/"
          ...
          .. "#lines-{_A.LSTART}"
          .. "{(_A.LEND > _A.LSTART and (':' .. _A.LEND) or '')}",
      -- example: https://codeberg.org/fcbry/gitlinker.nvim/blame/commit/a570f22ff833447ee0c58268b3bae4f7197a8ad8/LICENSE#L4-L7
      ["^codeberg%.org"] = "https://codeberg.org/"
          .. "{_A.ORG}/"
    ...
    default_branch = {
      -- example: https://github.com/fcbry/gitlinker.nvim/blob/master/lua/gitlinker.lua#L3-L4
      ["^github%.com"] = "https://github.com/"
          .. "{_A.ORG}/"
          .. "{_A.REPO}/blob/"
          .. "{_A.DEFAULT_BRANCH}/"
          ...
          .. "#L{_A.LSTART}"
          .. "{(_A.LEND > _A.LSTART and ('-L' .. _A.LEND) or '')}",
      -- example: https://gitlab.com/fcbry/test/blob/main/test.lua#L3-L4
      ["^gitlab%.com"] = "https://gitlab.com/"
          .. "{_A.ORG}/"
          .. "{_A.REPO}/blob/"
          .. "{_A.DEFAULT_BRANCH}/"
      ...
      ["^bitbucket%.org"] = "https://bitbucket.org/"
          ...
          .. "#lines-{_A.LSTART}"
          .. "{(_A.LEND > _A.LSTART and (':' .. _A.LEND) or '')}",
      -- example: https://codeberg.org/fcbry/gitlinker.nvim/src/branch/main/LICENSE#L4-L6
      ["^codeberg%.org"] = "https://codeberg.org/"
          .. "{_A.ORG}/"
          .. "{_A.REPO}/src/branch/"
          .. "{_A.DEFAULT_BRANCH}/"
